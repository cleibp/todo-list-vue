<h1 align="center"> 🚀 TODO LIST | VUE </h1>

## ✍️ Descrição
Exemplificação de TODO LIST usando framework js vue
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/todo-list-vue.git
    ```
1. Download:
    ### Download Manual
...
[Publicação em Codepen](https://codepen.io/cleibp/pen/YzdYwQq) 
